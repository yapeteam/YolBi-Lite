package cn.yapeteam.yolbi.utils.render.font.impl.rise;
 ...
 * @since 11/03/2021
 */
public class FontRenderer extends cn.yapeteam.yolbi.utils.render.font.Font {
    ...
    public void fillCharacters(final FontCharacter[] characters, final int style) {
        ...
        for (int i = 0; i < characters.length; ++i) {
            ...
            final BufferedImage charImage = new BufferedImage(MathHelper.ceil(
                    (float) charRectangle.getWidth()) + MARGIN_WIDTH * 2, MathHelper.ceil(
