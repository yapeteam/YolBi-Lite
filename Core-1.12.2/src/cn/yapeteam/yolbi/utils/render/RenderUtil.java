...
public class RenderUtil {
    ...
    public static Vector2f esp(EntityLivingBase entity, float partialTicks) {
        ...
        cn.yapeteam.yolbi.utils.vector.Vector3d[] vectors = new cn.yapeteam.yolbi.utils.vector.Vector3d[]{new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.minX, aabb.minY, aabb.minZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.minX, aabb.maxY, aabb.minZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.maxX, aabb.minY, aabb.minZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.maxX, aabb.maxY, aabb.minZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.minX, aabb.minY, aabb.maxZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.minX, aabb.maxY, aabb.maxZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.maxX, aabb.minY, aabb.maxZ), new cn.yapeteam.yolbi.utils.vector.Vector3d(aabb.maxX, aabb.maxY, aabb.maxZ)};
        ReflectUtil.EntityRenderer$setupCameraTransform(entityRenderer, partialTicks, 0);
        Vector4d position = null;
        int vecLength = vectors.length;

        for (cn.yapeteam.yolbi.utils.vector.Vector3d vector3d : vectors) {
            cn.yapeteam.yolbi.utils.vector.Vector3d vector = vector3d;
    ...
    private static cn.yapeteam.yolbi.utils.vector.Vector3d project2D(int scaleFactor, double x, double y, double z) {
