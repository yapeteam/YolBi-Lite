...
//                RenderManager.rectangle(x, y + pickerHeight - 2, pickerWidth - edge * 2, 5, Color.BLACK);
            ...
            if (colorPickerDown) {
                ...
                pointer.x = MathHelper.clamp(pointer.x, 0f, (float) pickerWidth);
                pointer.y = MathHelper.clamp(pointer.y, 0f, (float) pickerHeight);
                ...
                huePointer = MathHelper.clamp(huePointer, (float) 0, (float) huePickerWidth);
