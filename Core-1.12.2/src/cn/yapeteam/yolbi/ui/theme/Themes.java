package cn.yapeteam.yolbi.ui.theme;
...
public enum Themes{
    ...
    AQUA("Aqua", new Color(185, 250, 255), new Color(79, 199, 200), TextFormatting.AQUA,Color.WHITE, KeyColors.AQUA),
    BANANA("Banana", new Color(253, 236, 177), new Color(255, 255, 255), YELLOW,Color.WHITE, KeyColors.YELLOW),
    BLEND("Blend", new Color(71, 148, 253), new Color(71, 253, 160), TextFormatting.AQUA,Color.WHITE, KeyColors.AQUA, KeyColors.LIME),
    ...
    DIGITAL_HORIZON("Digital Horizon", new Color(95, 195, 228), new Color(229, 93, 135), TextFormatting.AQUA,Color.WHITE, KeyColors.AQUA, KeyColors.RED, KeyColors.PINK),
    EXPRESS("Express", new Color(173, 83, 137), new Color(60, 16, 83), DARK_PURPLE,Color.WHITE, KeyColors.PURPLE, KeyColors.PINK),
    LIME_WATER("Lime Water", new Color(18, 255, 247), new Color(179, 255, 171), TextFormatting.AQUA,Color.WHITE, KeyColors.AQUA, KeyColors.LIME),
    ...
    SNOWY_SKY("Snowy Sky", new Color(1, 171, 179), new Color(234, 234, 234), new Color(18, 232, 232), TextFormatting.AQUA,Color.WHITE, KeyColors.AQUA, KeyColors.GRAY),
    ...
    WATER("Water", new Color(12, 232, 199), new Color(12, 163, 232), TextFormatting.AQUA,Color.WHITE, KeyColors.AQUA, KeyColors.DARK_BLUE),
    ...
    private final TextFormatting chatAccentColor;
    private final ArrayList<KeyColors> keyColors;
    private final boolean triColor;

    // Constructor for bicolor themes (only two colors)
    Themes(String themeName, Color firstColor, Color secondColor, TextFormatting chatAccentColor, Color textColor, KeyColors... keyColors) {
    ...
    Themes(String themeName, Color firstColor, Color secondColor, Color thirdColor, TextFormatting chatAccentColor,Color textColor, KeyColors... keyColors) {
        this.themeName = themeName;
