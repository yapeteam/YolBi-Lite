...
public class Scaffold extends Module {
    ...
    public ModeValue<String> rayCastMode = new ModeValue("RayCastMode", "Strict", new String[]{"Strict", "Static"});
    ...
    public void onUpdate(EventUpdate event) {
        ...
        if(telly.getValue()&&!mc.player.isOnGround()) targetRotation=new Vector2f(mc.player.getXRot(),mc.player.getYRot());
