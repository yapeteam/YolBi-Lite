...
public class KillAura extends Module
{
    ...
    public NumberValue<Integer> rotationSpeed=new NumberValue("RotationSpeed",90,0,180,0.1);
    public NumberValue<Integer> rotationSpeed2=new NumberValue("RotationSpeed2",90,0,180,0.1);
