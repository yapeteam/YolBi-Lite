...
package cn.yapeteam.yolbi.font.slick;

import cn.yapeteam.yolbi.font.slick.font.Glyph;
import cn.yapeteam.yolbi.font.slick.font.GlyphPage;
import cn.yapeteam.yolbi.font.slick.font.HieroSettings;
import cn.yapeteam.yolbi.font.slick.font.effects.Effect;
import cn.yapeteam.yolbi.font.slick.opengl.Texture;
import cn.yapeteam.yolbi.font.slick.opengl.TextureImpl;
import cn.yapeteam.yolbi.font.slick.opengl.renderer.Renderer;
import cn.yapeteam.yolbi.font.slick.opengl.renderer.SGL;
import cn.yapeteam.yolbi.font.slick.util.ResourceLoader;
 ...
 */
public class UnicodeFont implements cn.yapeteam.yolbi.font.slick.Font {
	...
	/**
	 * Identical to {@link #drawString(float, float, String, cn.yapeteam.yolbi.font.slick.Color, int, int)} but returns a
	 ...
	 */
	public DisplayList drawDisplayList (float x, float y, String text, cn.yapeteam.yolbi.font.slick.Color color, int startIndex, int endIndex) {
		if (text == null) throw new IllegalArgumentException("text cannot be null.");
	...
	public void drawString (float x, float y, String text, cn.yapeteam.yolbi.font.slick.Color color, int startIndex, int endIndex) {
		drawDisplayList(x, y, text, color, startIndex, endIndex);
	}

	public void drawString (float x, float y, String text) {
		drawString(x, y, text, cn.yapeteam.yolbi.font.slick.Color.white);
	}
	...
	/**
	 * @see cn.yapeteam.yolbi.font.slick.Font#getWidth(java.lang.String)
	 */
	...
	/**
	 * @see cn.yapeteam.yolbi.font.slick.Font#getHeight(java.lang.String)
	 */
