...
import cn.yapeteam.yolbi.font.slick.opengl.GLUtils;
...
import cn.yapeteam.yolbi.font.slick.util.BufferedImageUtil;
...
public class TrueTypeFont implements Font {
	...
	public void drawString(float x, float y, String whatchars,
			cn.yapeteam.yolbi.font.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, cn.yapeteam.yolbi.font.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           cn.yapeteam.yolbi.font.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, cn.yapeteam.yolbi.font.slick.Color.white);
	}
