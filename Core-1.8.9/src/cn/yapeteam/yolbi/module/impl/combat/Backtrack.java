...
public class Backtrack extends Module {
    ...
    private final NumberValue<Double> amount = new NumberValue<Double>("Amount", 1.0, 1.0, 3.0, 0.1);
    ...
    public void onAttack(EventAttack e) {
        val target = (val) TargetManager.getTargets(3.6);
    }

    @Listener
    public void onTick(EventTick e) {
        target = (EntityLivingBase) TargetManager.getTargets(3.6);
    ...
    public void onPacketReceive(EventPacketReceive e) {
        ...
        if (e.getPacket() instanceof S18PacketEntityTeleport && (s18 = e.getPacket()).getEntityId() == target.getEntityId()) {
